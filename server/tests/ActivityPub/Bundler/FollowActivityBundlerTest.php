...
class FollowActivityBundlerTest extends KernelTestCase
{
    public function testBundleFromFollowing(): void
    {
        ...
        $actorAccount = AccountFactory::createOneWithUsernameAndInstance('testuser', AccountFactory::TEST_INSTANCE, [
            'owner' => $user,
        ]);
        $objectAccount = AccountFactory::createOneWithUsernameAndInstance('followeduser');
