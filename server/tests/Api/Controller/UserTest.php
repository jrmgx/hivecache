...
class UserTest extends BaseApiTestCase
{
    ...
    public function testShowPublicProfile(): void
    {
        ...
        AccountFactory::createOneWithUsernameAndInstance('publicuser', AccountFactory::TEST_INSTANCE, [
            'owner' => $user,
        ]);

        $privateUser = UserFactory::createOne(['username' => 'privateuser', 'isPublic' => false]);
        AccountFactory::createOneWithUsernameAndInstance('privateuser', AccountFactory::TEST_INSTANCE, [
            'owner' => $privateUser,
        ]);
