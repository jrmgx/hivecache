...
class MeBookmarkSocialControllerTest extends BaseApiTestCase
{
    public function testGetTimelineReturnsBookmarks(): void
    {
        ...
        $account = AccountFactory::createOne(['username' => 'otheruser']);
    ...
    public function testGetTagBookmarksReturnsBookmarks(): void
    {
        ...
        $account = AccountFactory::createOne(['username' => 'otheruser']);
        $tag = InstanceTagFactory::createOne(['name' => 'Tag Extern']);
        ...
        $this->assertUnauthorized('GET', '/users/me/bookmarks/social/tag/tag-extern');

        $this->client->enableProfiler();
        $this->request('GET', '/users/me/bookmarks/social/tag/tag-extern', ['auth_bearer' => $token]);
        $this->assertResponseIsSuccessful();
